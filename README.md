This script tidies up your contact info. It imports the data from an XLSX file, then makes sure phone numbers are all in the same format. It pulls out apartment, suite, or unit info into its own column to keep things clean.
