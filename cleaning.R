...
#        Some entrys contains apt or suite, this need to 
#        be defined in a new column adress 2. 
...
# cont: 2414 entrys, cont distinct: 2414 entrys. 
